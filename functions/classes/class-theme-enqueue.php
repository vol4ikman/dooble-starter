...
class QS_theme_enqueue{
    ...
    public static function qs_theme_scripts() {
        ...
        if(ENV == 'dev'){
            ...
            wp_register_script( 'methods', JS_INC . 'methods.js', array( 'jquery' ), THEME_VER, true );
            wp_register_script( 'event-handlers', JS_INC . 'event-handlers.js', array( 'jquery' , 'methods' ), THEME_VER, true );
            ...
            wp_localize_script( 'event-handlers', 'site_settings', $site_settings );
            wp_enqueue_script( 'methods' );
            wp_enqueue_script( 'event-handlers' );
